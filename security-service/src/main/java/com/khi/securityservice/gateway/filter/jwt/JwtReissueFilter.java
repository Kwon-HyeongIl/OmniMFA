package com.khi.securityservice.gateway.filter.jwt;
...
public class JwtReissueFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        String newAccessToken = jwtUtil.createJwt(JwtTokenType.ACCESS, loginId, role, 600_000L);
        String newRefreshToken = jwtUtil.createJwt(JwtTokenType.REFRESH, loginId, role, 86_400_000L);
