...
public class ReactiveRedisConfig {
        ...
        /*
         * 스프링 부트의 RedisAutoConfiguration은 RedisConnectionFactory 타입의 빈이 이미 있는지 확인하고,
         * 없으면 RedisConnectionFactory 타입의 빈을 생성.
         * Wenflux에서는 ReactiveRedisConnectionFactory 타입을 사용하지만 이는
         * RedisConnectionFactory의 상속을 받지 않음. (자동 생성으로 인한 충돌 발생)
         * 따라서, RedisConnectionFactory와 ReactiveRedisConnectionFactory 둘 모두를 상속받는
         * LettuceConnectionFactory를 반환.
         */
        @Bean
