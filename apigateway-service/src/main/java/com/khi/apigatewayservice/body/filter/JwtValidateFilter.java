...
import com.khi.apigatewayservice.body.enumeration.JwtTokenType;
import com.khi.apigatewayservice.body.util.JwtUtil;
...
public class JwtValidateFilter implements GlobalFilter {
    ...
    private static final Map<String, Set<HttpMethod>> ALLOWED_PATHS = Map.ofEntries(
            ...
            Map.entry("/onboarding/test", Set.of(HttpMethod.POST))
    );
